...
public class GameControl {
	...
	private static final CSIColor BORDER_COLOR = new CSIColor(42, 82, 190, 128);
	private static final CSIColor SHIP_COLOR = CSIColor.WHITE;
	private static final CSIColor STAR_COLOR = CSIColor.CERULEAN_BLUE;
	private static final CSIColor PLANET_COLOR = CSIColor.FERN_GREEN;
	private static final CSIColor FREIGHT_COLOR = CSIColor.BROWNER;
	private static final CSIColor MOND_COLOR = CSIColor.PINK;
